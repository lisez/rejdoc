...
function getReJDocString(input /*@params String*/){
	...
	for(var i=0; i<d.length; i++){
		...
		if( /(?:^\u4e2d\u83ef\u6c11\u570b.+\u5e74.+\u6708.+\u65e5$)/.test(term)	||
			/(?:^\u3010)/.test(term)						||
			/(?:^\u88c1\u5224[\u5b57\u865f\u65e5\u671f\u6848\u7531\u5168\u6587]+\uff1a|^\u6703\u8b70\u6b21\u5225\uff1a|^\u6c7a\u8b70\u65e5\u671f\uff1a|^\u8cc7\u6599\u4f86\u6e90\uff1a|^\u76f8\u95dc\u6cd5\u689d\uff1a|^\u6c7a\u8b70\uff1a|^\u8a0e\u8ad6\u4e8b\u9805\uff1a|\u63d0\u6848\uff1a$)/.test(term)									 ||
			/(?:\u7b2c[\d\u3001-]+\u689d\([\d\.]+\)$)/.test(term)	
			){o+="\n"+term+"\n";continue;}
		...
		if(!(/(?:[\uff0c\u3002\u3001])/gi.test(term))){
			// case name
			if(/(?:^[\u53f8\u6cd5\u6700\u9ad8\u81fa\u7063\u5317\u4e2d\u9ad8\u96c4\u798f\u5efa\u667a\u6167\u516c\u52d9\u54e1]{2,}.+[\u58f9\u8cb3\u53c1\u53c3\u8086\u4f0d\u9678\u67d2\u634c\u7396\u62fe\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341\u25cb\d]+\u5e74\u5ea6.+\u5b57\u7b2c[\u58f9\u8cb3\u53c1\u53c3\u8086\u4f0d\u9678\u67d2\u634c\u7396\u62fe\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341\u25cb\d]+\u865f$)/.test(term)){o+=term+"\n";continue;}
			
			// parites
			if(/(?:^[\u5148\u5f8c]?\u8a34?[\u539f\u88ab]\u544a|^[\u6cd5\u5b9a\u8a34\u8a1f]+[\u4ee3\u7406\u8868]+\u4eba|^[\u4ee3\u7406\u8868]+\u4eba|^\u79fb\u9001\u6a5f\u95dc|^\u88ab\u4ed8\u61f2\u6212\u4eba|^\u8a34\u9858\u4eba|^\u8072\u8acb\u8986\u5be9\u4eba|^\u8072\u8acb\u4eba|^\u76f8\u5c0d\u4eba|^\u518d?\u6297\u544a\u4eba|^\u88ab?\u4e0a\u8a34\u4eba|^\u50b5[\u52d9\u6b0a]\u4eba)/.test(term)){o+="\n"+term+"\n";continue;}
			
			// classical columns
			if(/(?:^[\u4e3b\u6587\u7406\u7531\u72af\u7f6a\u4e8b\u5be6\u53ca\u9644\u8868\u9644\u4ef6\u8a3b\uff1a]{2,}$)/.test(term)){o+= "\n" + term+"\n";continue;}
		...
		if(/(?:^[\u58f9\u8cb3\u53c1\u53c3\u8086\u4f0d\u9678\u67d2\u634c\u7396\u62fe\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341\u25cb]+\u3001|\u8aaa\uff1a)/.test(term)){o+= "\n" + term;continue;}
		if(/(?:^[(\uff08][\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341\u25cb]+[\uff09)])/.test(term)){o+= "\n" + term;continue;}
		if(/(?:^\d+\.\D)/.test(term)){o+= "\n" + term;continue;}
		if(/(?:^[(\uff08]\d+[)\uff09]\D)/.test(term)){o+= "\n" + term;continue;}
